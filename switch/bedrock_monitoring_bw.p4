...
READ_UPDATE_CMIN(1, 0)
READ_UPDATE_CMIN(2, 0)
READ_UPDATE_CMIN(3, 0)
READ_UPDATE_CMIN(0, 1)
READ_UPDATE_CMIN(1, 1)
READ_UPDATE_CMIN(2, 1)
READ_UPDATE_CMIN(3, 1)
READ_UPDATE_CMIN(0, 2)
READ_UPDATE_CMIN(1, 2)
READ_UPDATE_CMIN(2, 2)
READ_UPDATE_CMIN(3, 2)
READ_UPDATE_CMIN(0, 3)
READ_UPDATE_CMIN(1, 3)
READ_UPDATE_CMIN(2, 3)
READ_UPDATE_CMIN(3, 3)
...
SPLIT_FIELD(md, cmin_win0, cmin_win0_32_20, msb, 12, 0x1000)
SPLIT_FIELD(md, cmin_win1, cmin_win1_32_20, msb, 12, 0x1000)
SPLIT_FIELD(md, cmin_win2, cmin_win2_32_20, msb, 12, 0x1000)
SPLIT_FIELD(md, cmin_win3, cmin_win3_32_20, msb, 12, 0x1000)
...
table rate_limit {
    reads {
        ...
        ipv4.dstAddr       : exact;
        md.winId           : exact;
        md.cmin_win0_32_20 : range;
        md.cmin_win1_32_20 : range;
        md.cmin_win2_32_20 : range;
        md.cmin_win3_32_20 : range;
    }
    actions {
        send_ban_digest;
        nop;
...
control ingress {
    ...
    // apply(read_update_cmin_win1_hash3_tab);
    // apply(read_update_cmin_win2_hash3_tab);
    // apply(read_update_cmin_win3_hash3_tab);
