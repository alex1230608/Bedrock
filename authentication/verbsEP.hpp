...
public:
  ...
  struct ibv_mr * reg_mem_for_mw(void *buf, size_t size){
      return ibv_reg_mr(this->pd, buf, size, IBV_ACCESS_LOCAL_WRITE | IBV_ACCESS_MW_BIND);
  }
